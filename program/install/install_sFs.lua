...
secrets_file.writeLine(utils.hex_from_string(salt))
secrets_file.writeLine(utils.hex_from_string(e_phrase))
secrets_file.writeLine(utils.hex_from_string(phrase_nonce))
secrets_file.writeLine(utils.hex_from_string(e_encryption_key))
secrets_file.writeLine(utils.hex_from_string(encryption_key_nonce))
term.blit("done", "dddd", "ffff")
print()
sleep(0.1)
secrets_file.close()
